                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="matricula" readonly="readonly" name="matricula" maxlength="7" placeholder="Ejemplo: IH8-PPL" value="${bean.matricula}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="nro_pasajero">Número de pasajeros</label>
                                    <input type="number" class="form-control" id="nro_pasajero" name="nroPasajeros" min="1" max="99" placeholder="Ingrese el número de pasajeros" value="${bean.nroPasajeros}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="nro_puertas">Número de puertas</label>
                                    <input type="number" class="form-control" id="nro_puertas" name="nroPuertas" min="1" max="9" placeholder="Ingrese el número de puertas" value="${bean.nroPuertas}">
                                </div>
                            </div> 
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="precio_dia" name="precioDia" maxlength="45" placeholder="Ejemplo:  85.20" value="${bean.precioDia}">
                                </div>
                            </div> 
                            <div class="col-sm-6">
                                <div class="form-group">
