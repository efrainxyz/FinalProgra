        ...
        <div class="content">
            <div class="container">
                <div class="col-sm-12">
                    ...
                    <h1>Modificar información del auto</h1>
                    <hr>
                    <form>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="matricula" name="matricula" maxlength="7" placeholder="Ejemplo: IH8-PPL" disabled>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary">Modificar Auto
                                    </button>
                                </div>
                        </div>
                    </form>
