                    ...
                    <div class="box">
                        <form method="post" action="checkout4.html">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                <li><a href="reserva1"><i class="fa fa-map-marker"></i><br>Recojo y Retorno</a>
                                </li>
                                ...
                                <li class="active"><a href="reserva4"><i class="fa fa-eye"></i><br>Resumen</a>
                                </li>
                            </ul>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="reserva3" class="btn btn-default"><i class="fa fa-chevron-left"></i>Regresar a coberturas y opciones</a>
                                </div>
